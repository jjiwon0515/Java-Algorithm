...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        // 포함 관계
        System.out.println(s.contains("Java")); // 포함된디면 true / 포함되지 않는다면 false
        System.out.println(s.contains("C#")); // false
        System.out.println(s.indexOf("Java")); // 위치 정보 7
        System.out.println(s.indexOf("C#")); // 포함되어있지 않으면 -1을 반환
        System.out.println(s.indexOf("and")); //처음 일치하는 위치 정보
        System.out.println(s.lastIndexOf("and")); // 마지막으로 일치하는 문자열 위치
